...
const App = () => {
  ...
  const compararProductosPorLikes = (a, b) => {
    const productoA = a.actualizado;
    const productoB = b.actualizado;
...
ruta = "ab"
  ...
  else if(rutaa=="https://frontend-paca.onrender.com/administracion14152024"){
    ruta = "adm"
  }
  const aa = useParams();
  ...
  return (
     ...
     */}
      ...
      <BrowserRouter basename="/paga-ginita">
        ...
        <Route path="/administracion14152024" element={<Targeta2 blogs={blogs2}  />}></Route>
        <Route path="/ventas-az" element={<Targeta3 blogs={blogs4}  />}></Route>
